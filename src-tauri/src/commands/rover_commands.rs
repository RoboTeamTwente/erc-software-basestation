...
#[tauri::command]
pub async fn request_coordinates(state: State<'_, UdpServiceHandle>, rover_addr: State<'_, RoverAddress>,) -> Result<(i16, i16), i16> {
...
#[tauri::command]
pub async fn request_weight(state: State<'_, UdpServiceHandle>, rover_addr: State<'_, RoverAddress>,) -> Result<i16, i16> {
...
#[tauri::command]
pub async fn request_measurement(state: State<'_, UdpServiceHandle>, rover_addr: State<'_, RoverAddress>, camera1: String, x1: f64, y1: f64, camera2: String, x2: f64, y2: f64) -> Result<i16, i16> {
...
#[tauri::command]
pub async fn send_pixel(state: State<'_, UdpServiceHandle>, rover_addr: State<'_, RoverAddress>, camera: String, x: f64, y: f64) -> Result<(), ()> {
...
#[tauri::command]
pub async fn select_object(state: State<'_, UdpServiceHandle>, rover_addr: State<'_, RoverAddress>, object_id: u32) -> Result<(), ()> {
