<script lang="ts">
    ...
    import { displayedMap, pinnedCoords, waypoints, startPoint, endPoint, hoveredNavId } from "$lib/stores/map";
    import type { PinnedCoord } from "$lib/stores/map";
    import { gpsPosition, scienceLocations, probingLocations } from '$lib/stores/map';
    import { hoveredScienceId, hoveredProbingId } from '$lib/stores/map';
    import type { GpsPosition } from '$lib/stores/map';
